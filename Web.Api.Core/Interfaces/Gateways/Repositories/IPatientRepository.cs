...
namespace Web.Api.Core.Interfaces.Gateways.Repositories
{
    ...
    {
        Task<List<PatientDetails>> GetPatientDetails(string companyId, string patientId, string gMapLinkSatus, DateTime assignedFromDate, DateTime assignedToDate, string SearchStatus);
